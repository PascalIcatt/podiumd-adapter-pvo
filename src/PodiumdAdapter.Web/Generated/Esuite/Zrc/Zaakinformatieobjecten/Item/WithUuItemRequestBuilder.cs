...
using System;
namespace Generated.Esuite.ZrcClient.Zaakinformatieobjecten.Item {
    /// <summary>
    /// Builds and executes requests for operations under \zaakinformatieobjecten\{uuid}
    /// </summary>
    public class WithUuItemRequestBuilder : BaseRequestBuilder {
        ...
        public WithUuItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/zaakinformatieobjecten/{uuid}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new WithUuItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithUuItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/zaakinformatieobjecten/{uuid}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<ZaakInformatieobject?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<ZaakInformatieobject> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
